...
Программа реализует функцию выполняющую обработку введённых данных. Вот краткое описание ключевых частей программы:
...
Программа реализует обработку входных данные в функцию. Вот краткое описание ключевых частей программы:
...
Программа реализует обработку командной строки для выполнения различных операций в зависимости от введенного файла. Вот краткое описание ключевых частей программы:
